...
const downloadPDF = async (orders) => {
  ...
  try {
    ...
    doc.text(`Email: ${order.order_email}`, 14, 46);
...
<template>
    <div class="popup" v-if="isVisible">
        ...
        <div class="popup-content">
            ...
            <div v-for="order in orderDetails" :key="order.orderId"
                ...
                <div class="flex justify-between items-center p-4 rounded bg-slate-200">
                    <span class="font-semibold">Commandé le : {{ new Date(order.dateOrder).toLocaleDateString()
                        }}</span>
                ...
                <div class="flex justify-between border p-4 rounded bg-slate-100">
                    ...
                    <div class="flex items-center mb-2">
                        <div class="mr-2">
                            ...
                            <svg v-if="order.deliveryStatus === 'confirmed'" width="26" height="29" viewBox="0 0 26 29"
                            ...
                            <svg v-else-if="order.deliveryStatus === 'in_progress'" width="29" height="29"
                            ...
                            <svg v-else class="w-6 h-6 text-red-500" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M12 8v4m0 0h0v4m0-4h-2.5" stroke="currentColor" stroke-width="2"
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <span v-else class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-800"
            ...
            <div class="buttons">
                ...
                <button @click="" class="bg-red text-white rounded mx-6 px-5 py-2">Annuler et Rembourser</button>
