...
<template>
  <div class="w-3/5 mt-10">
    ...
    <div v-else >
      <div v-for="order in paginatedOrders" :key="order.orderId" class="border p-4 m-8 rounded shadow  list-none" >
        ...
        <div class="flex justify-between border p-4 rounded bg-slate-100">
          ...
          <div class="flex items-center mb-2">
            <div class="mr-2">
              ...
              <svg v-if="order.deliveryStatus === 'confirmed'" width="26" height="29" viewBox="0 0 26 29" fill="none"
                ...
                <path d="M17.0436 12.3682L9.30688 14.4977L17.1473 16.4821L24.9928 14.4251L17.0436 12.3682Z"
                  fill="#D8B775" />
                <path
                ...
                <path d="M5.93896 5.21094L6.32037 4.99076L6.76341 5.758L6.38201 5.97818L5.93896 5.21094Z"
                  fill="#D8B775" />
                <path d="M3.50952 14.2722L4.27691 13.8294L4.49709 14.2108L3.7297 14.6536L3.50952 14.2722Z"
                  fill="#D8B775" />
                <path d="M14.6134 7.85864L15.3808 7.41578L15.601 7.79721L14.8336 8.24006L14.6134 7.85864Z"
                  fill="#D8B775" />
                <path d="M3.51123 7.79956L3.73146 7.41818L4.49875 7.86113L4.27853 8.24251L3.51123 7.79956Z"
                  fill="#D8B775" />
                <path d="M5.93933 16.8601L6.38229 16.0928L6.76374 16.3129L6.32078 17.0802L5.93933 16.8601Z"
                  fill="#D8B775" />
                <path d="M12.3461 5.75513L12.789 4.9878L13.1705 5.20793L12.7275 5.97526L12.3461 5.75513Z"
                  fill="#D8B775" />
              </svg>


              <svg v-else-if="order.deliveryStatus === 'in_progress'" width="29" height="29" viewBox="0 0 29 29"
              ...
              <svg v-else-if="order.deliveryStatus === 'delivered'" width="26" height="29" viewBox="0 0 26 29"
                fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M8.3688 19.855C3.89155 19.2644 0.518066 15.4147 0.518066 10.8967C0.518066 5.91233 4.57039 1.8606 9.55547 1.8606C14.5406 1.8606 18.5929 5.91233 18.5929 10.8967C18.5929 11.1402 18.5825 11.3837 18.567 11.6221L17.686 11.5495C17.7016 11.3319 17.7119 11.1143 17.7119 10.8967C17.7119 6.39936 14.0535 2.74659 9.56066 2.74659C5.06268 2.74659 1.40937 6.40454 1.40937 10.8967C1.40937 14.9743 4.4512 18.4457 8.48798 18.9794L8.3688 19.855Z"
                  fill="#D8B775" />
              ...
              <svg v-else class="w-6 h-6 text-red-500" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 8v4m0 0h0v4m0-4h-2.5" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="grid grid-cols-4 gap-4 items-center">
            ...
            <div class="w-full mx-8">
              <v-carousel height="200" hide-delimiters>
                <v-carousel-item v-for="(product, i) in order.products" :key="i">
                  <img :src="getImagePath(product.image)" alt="Slide" class="w-full h-full object-cover" />
                </v-carousel-item>
              </v-carousel>
            </div>
          ...
          <div class="col-span-2 flex flex-col space-y-2 m-12">
            ...
            <ButtonDefault @click="reorder(order)" label="Commander à nouveau" customClasses="bg-[#D8B775] text-white rounded-md">
            </ButtonDefault>
          </div>
        </div>
      </div>
