    ...
    <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
      <div class="flex w-full flex-wrap gap-3 sm:gap-5">
        <div class="flex min-w-47.5">
          ...
          <div class="w-full">
            <p class="font-semibold text-[#C28B00]">Total Revenus</p>
        ...
        <div class="flex min-w-47.5">
          ...
          >
            <span class="block h-2.5 w-full max-w-2.5 rounded-full bg-[#FFEFCF]"></span>
          </span>
          <div class="w-full">
            <p class="font-semibold text-[#FFEFCF]">Total Ventes</p>
            <p class="text-sm font-medium">12.04.2022 - 12.05.2022</p>
          </div>
        </div>
      </div>
