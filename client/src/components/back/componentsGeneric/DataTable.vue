...
<template>
  <div class="overflow-auto rounded-lg border border-gray-3 shadow-9 m-5">
    ...
    <div class="flex justify-end m-2">
      <ButtonMini @click="downloadCSV" label="CSV" customClasses="text-white rounded-md bg-[#C28B00]"><svg width="22px"
      ...
      <ButtonMini @click="downloadExcel" label="Excel" customClasses="text-white rounded-md bg-[#C28B00]"><svg
          width="22px" height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M12 12V19M12 19L9.75 16.6667M12 19L14.25 16.6667M6.6 17.8333C4.61178 17.8333 3 16.1917 3 14.1667C3 12.498 4.09438 11.0897 5.59198 10.6457C5.65562 10.6268 5.7 10.5675 5.7 10.5C5.7 7.46243 8.11766 5 11.1 5C14.0823 5 16.5 7.46243 16.5 10.5C16.5 10.5582 16.5536 10.6014 16.6094 10.5887C16.8638 10.5306 17.1284 10.5 17.4 10.5C19.3882 10.5 21 12.1416 21 14.1667C21 16.1917 19.3882 17.8333 17.4 17.8333"
            stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
        </svg></ButtonMini>
      <ButtonMini @click="downloadPDF" label="PDF" customClasses="text-white rounded-md bg-[#C28B00]"><svg width="22px"
          height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M12 12V19M12 19L9.75 16.6667M12 19L14.25 16.6667M6.6 17.8333C4.61178 17.8333 3 16.1917 3 14.1667C3 12.498 4.09438 11.0897 5.59198 10.6457C5.65562 10.6268 5.7 10.5675 5.7 10.5C5.7 7.46243 8.11766 5 11.1 5C14.0823 5 16.5 7.46243 16.5 10.5C16.5 10.5582 16.5536 10.6014 16.6094 10.5887C16.8638 10.5306 17.1284 10.5 17.4 10.5C19.3882 10.5 21 12.1416 21 14.1667C21 16.1917 19.3882 17.8333 17.4 17.8333"
            stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500 ">
      <thead class="bg-gray-3">
        <tr>
          <th v-for="header in displayedHeaders" :key="header" scope="col"
            class="pl-2 py-4 font-medium text-gray-100 text-center">
            <div class="flex flex-row items-center">
              {{ header }}
              <!-- Filtering input -->
              <input v-if="props.filterableColumns.includes(header)" v-model="filters[header]" placeholder="Filter"
                class="ml-2 p-1 w-28 border border-gray-300 rounded" />
            </div>
          </th>
        ...
        <tr v-for="(row) in paginatedData" :key="row.id" class="hover:bg-gray-3">
          ...
          <td class="px-6 py-4 text-center">
            ...
            <div class="flex justify-start gap-4">
              ...
              <a @click="props.editUser(row.id)" class="">
                <!-- Delete icon -->
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="h-6 w-6">
                  <path stroke-linecap="round" stroke-linejoin="round"
