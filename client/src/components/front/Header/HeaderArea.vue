...
<template>
    <header class="flex flex-col">
        <div class="bg-[#1D1D1D] shadow w-full h-28 flex flex-row justify-around items-center px-4 md:px-14 lg:px-32">
        ...
        <nav :class="{ 'hidden': !showNav }"
            ...
            <router-link to="/" class="text-white my-2 flex items-center"
                :class="{ 'flex flex-col justify-center !text-[#D8B775]': route.path === '/' }">ACCUEIL<span
                    class="text-[#D8B775] h-0 font-bold " v-if="route.path === '/'">*</span></router-link>
            <router-link to="/homme" class="text-white my-2 flex items-center"
                :class="{ 'flex flex-col justify-center !text-[#D8B775]': route.path === '/homme' }">HOMME<span
                    class="text-[#D8B775] h-0" v-if="route.path === '/homme'">*</span></router-link>
            <router-link to="/femme" class="text-white my-2 flex items-center"
                :class="{ 'flex flex-col justify-center !text-[#D8B775]': route.path === '/femme' }">FEMME<span
                    class="text-[#D8B775] h-0" v-if="route.path === '/femme'">*</span></router-link>
            <router-link to="/enfant" class="text-white my-2 flex items-center"
                :class="{ 'flex flex-col justify-center !text-[#D8B775]': route.path === '/enfant' }">ENFANT<span
                    class="text-[#D8B775] h-0" v-if="route.path === '/enfant'">*</span></router-link>
            <router-link to="/marque" class="text-white my-2 flex items-center"
                :class="{ 'flex flex-col justify-center !text-[#D8B775]': route.path === '/marque' }">MARQUE<span
                    class="text-[#D8B775] h-0" v-if="route.path === '/marque'">*</span></router-link>
            <router-link to="/contact" class="text-white my-2 flex items-center"
                :class="{ 'flex flex-col justify-center !text-[#D8B775]': route.path === '/contact' }">CONTACT<span
                    class="text-[#D8B775] h-0" v-if="route.path === '/contact'">*</span></router-link>
        </nav>
    </header>
</template>
