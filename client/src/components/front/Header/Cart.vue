...
<template>
  <div :class="['nav-item', sideBarType === 'back' ? 'm-2' : '']" >
    <a href="#" class="flex flex-row gap-1">
      <svg :width="sideBarType === 'back' ? 27 : 17" :height="sideBarType === 'back' ? 27 : 17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="relative" ref="target">
        ...
        >
          ...
          <ul v-if="totalProducts > 0" class="flex flex-col gap-5 border-b border-stroke px-4 py-4">
          ...
          <div v-else class="px-4 py-4 text-center text-sm font-medium text-gray-600">
