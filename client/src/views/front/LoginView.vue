...
<template>
  <DefaultLayout>
    ...
    <DefaultAuthCard subtitle="E-parfums" title="Connectez-vous">
      ...
      <InputGroup label="Mot de passe" type="password" placeholder="6+ Characters, 1 Capital letter" :value="password"
      ...
      <div class="mt-6 ml-5">
        <p class="font-medium">
          <router-link to="/mot-passe-oublie" class="text-[#C58940]">Mot de passe oublié ?</router-link>
        </p>
      </div>
      <div class="mb-5 mt-6">
        <input type="submit" @click="login" value="Se connecter"
      ...
      <div class="mt-6 text-center">
        <p class="font-medium">
          ...
          <router-link to="/inscription" class="text-[#C58940]">Inscrivez-vous.</router-link>
        </p>
      </div>
    </DefaultAuthCard>
  </DefaultLayout>
