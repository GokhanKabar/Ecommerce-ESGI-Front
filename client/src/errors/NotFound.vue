    ...
    <DefaultLayout>
        ...
        <div>
            <div class="container flex flex-col items-center justify-center px-5">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="400" height="400" class="mt-10">
                    <g id="freepik--Floor--inject-63">
                        <ellipse id="freepik--floor--inject-63" cx="250.56" cy="365.12" rx="240.31" ry="124.36"
                    ...
                    <g id="freepik--Shadows--inject-63">
                        <ellipse id="freepik--Shadow--inject-63" cx="398.11" cy="403.67" rx="49.29" ry="28.46"
                    ...
                    <g id="freepik--Window--inject-63">
                        <g id="freepik--window--inject-63">
                            ...
                            <path
                                ...
                                style="fill:#455a64;opacity:0.5"></path>
                            <path
                        ...
                        <g id="freepik--404--inject-63">
                            ...
                            <g id="freepik--404--inject-63">
                                ...
                                <path
                                    ...
                                    style="opacity:0.30000000000000004"></path>
                                <path d="M299.81,177.75a1.14,1.14,0,0,0-1.07.13l-6.43,3.71v-8.17Z" style="opacity:0.15">
                                </path>
                                <path
                    ...
                    <g id="freepik--speech-bubble--inject-63">
                        <g id="freepik--speech-bubble--inject-63">
                            ...
                            <g id="freepik--dead-emoji--inject-63">
                                <path
                ...
                <div>
                    ...
                    <router-link to="/" class="block mx-auto px-5 py-3 text-sm font-medium shadow-2xl text-white rounded-lg  !bg-primary w-60 text-center">
